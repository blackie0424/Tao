                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <svg fill="#FF2D20" width="64px" height="64px" viewBox="0 0 64.00 64.00" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" stroke="#FF2D20" stroke-width="0.00064">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.768"/>
                                            <g id="SVGRepo_iconCarrier">
                                            <title/>
                                            <path d="M36,22.74V21.10193a3.09593,3.09593,0,0,0-1.99084-2.88806,3,3,0,1,0-4.01832,0A3.09593,3.09593,0,0,0,28,21.10193V22.74a6.97916,6.97916,0,0,0,8,0Z"/>
                                            <path d="M34.00916,50.21387a3,3,0,1,0-4.01832,0A3.09593,3.09593,0,0,0,28,53.10193V54.74a6.97916,6.97916,0,0,0,8,0V53.10193A3.09593,3.09593,0,0,0,34.00916,50.21387Z"/>
                                            <path d="M20,38.74V37.10193a3.09593,3.09593,0,0,0-1.99084-2.88806,3,3,0,1,0-4.01832,0A3.09593,3.09593,0,0,0,12,37.10193V38.74a6.97916,6.97916,0,0,0,8,0Z"/>
                                            <path d="M52,38.74V37.10193a3.09593,3.09593,0,0,0-1.99084-2.88806,3,3,0,1,0-4.01832,0A3.09593,3.09593,0,0,0,44,37.10193V38.74a6.97916,6.97916,0,0,0,8,0Z"/>
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">服務項目</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                為了解決在部落中聽族人對話時，時常發生不了解族語的意思，雖然在聊天過程中會有人出來解釋，讓對話順利進行，但要如何能夠自動的辨識出對話內容及意思，讓對話過程更加順暢，這是最想達成的目標，簡單來說，我們想要建立屬於達悟族雨的語音辨識軟體。
                                                為了達到這麼目標，我們現在需要搜集這些單詞的聲音檔案，以利後續的語音辨識功能開發。
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">提供族語</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        本系統提供兩個方式讓您可以輕鬆提供族語資料，第一個方式是由您自己新增圖片、中文文字及族語音檔，系統會建立這個單詞的資料，第二個方式，係痛會提供您你一個圖像及中文，請嘗試用族語說出，例如，看到白毛圖片，你可以說是among或是ilek，擇一回應即可。
                                    </p>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg fill="#FF2D20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32px" height="32px" viewBox="0 0 310.42 310.42" xml:space="preserve" stroke="#FF2D20">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
                                        <g id="SVGRepo_iconCarrier"> <g> <g> <path d="M273.586,214.965c49.111-49.111,49.11-129.021,0-178.132s-129.021-49.111-178.131,0 C53.792,78.497,47.481,140.462,76.509,188.85c0,0,2.086,3.496-0.73,6.312c-16.064,16.064-64.263,64.263-64.263,64.263 c-12.79,12.79-15.837,30.675-4.493,42.02l1.953,1.951c11.343,11.345,29.229,8.301,42.02-4.49c0,0,48.096-48.097,64.128-64.128 c2.95-2.951,6.448-0.866,6.448-0.866C169.957,262.938,231.923,256.629,273.586,214.965z M118.711,191.71 c-36.288-36.288-36.287-95.332,0.001-131.62c36.287-36.287,95.332-36.288,131.618,0c36.289,36.287,36.289,95.332,0,131.62 C214.043,227.997,154.999,227.997,118.711,191.71z"/> <g> <path d="M190.987,163.91h-12.113c-4.399,0-8,3.6-8,8v12.111c0,4.399,3.601,8,8,8h12.113c4.399,0,8-3.601,8-8V171.91 C198.987,167.51,195.387,163.91,190.987,163.91z"/> <path d="M185.755,56.315h-1.65c-21.52,0-39.025,17.507-39.025,39.027c0,8.143,6.601,10.376,14.744,10.376 c8.145,0,14.746-2.233,14.746-10.376c0-5.259,4.277-9.538,9.535-9.538h1.65c5.26,0,9.536,4.279,9.536,9.538 c0,4.182-3.346,8.203-8.808,14.418c-7.264,8.265-16.3,18.55-16.3,34.308c0,8.144,6.602,10.376,14.744,10.376 c8.144,0,12.754-2.48,14.745-10.376c1.13-4.478,3.406-8.519,8.963-14.843c7.192-8.186,16.146-18.375,16.146-33.883 C224.782,73.823,207.275,56.315,185.755,56.315z"/> </g> </g> </g> </g>
                                    </svg>
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">單詞查詢</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        請提供族語音檔（單詞），系統將盡可能幫你搜尋初合適的單詞，例如，上傳ilek的族語音檔，系統將會送出合適的白毛圖像及中文字
                                    </p>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <svg fill="#FF2D20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32px" height="32px" viewBox="0 0 459.32 459.32" xml:space="preserve" stroke="#FF2D20">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="1.837276"/>
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">詞庫瀏覽</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        列出目前系統中所收錄的所有單詞，您可以根據需求挑選單詞進行個別瀏覽，並播放單詞族語。
                                    </p>
                                </div>
